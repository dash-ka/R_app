                            ...
                            mainPanel(
                              fluidRow(
                                ...
                                column(4, h3("STEP 1",style="color:black;text-align:center"),
                                      br(),
                                       helpText("MINSPLIT: The minimum number of observations that must exist in a node in order for a split to be attempted."),
                                       ...
                                       helpText("MINBUCKET: The minimum number of observations in any terminal leaf."),
                                       sliderInput("minbucket","",
                                                                  ...
                                                                  step=1),
                                       br(),
                                       helpText("CP: Complexity parameter."),
                                       sliderInput("cp","",
                                                                  value=c(0.01, 0.1),
                                                                  min=0,
                                                                  max=0.5,
                                                                  step=0.01),
                                       br(),
                                       helpText("MAXDEPTH: Set the maximum depth of any node of the final tree."),
...
server<- function(input, output) {
  ...
  output$mmce <-renderText({print(paste("The best hyperparameter combination yields a mean misclassification error equal to : ", round(mmce(), digits = 4)))})
